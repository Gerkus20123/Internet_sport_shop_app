          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:w-2/3">
            ...
            <div>
              ...
              <div className="flex flex-col space-y-4 items-center">
                <a href="https://facebook.com" className="hover:text-blue-400 transition-colors duration-200">
                  {/* Ikona Facebook */}
                ...
                <a href="https://instagram.com" className="hover:text-pink-400 transition-colors duration-200">
                  {/* Ikona Instagram */}
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="https://twitter.com" className="hover:text-gray-600 transition-colors duration-200">
                  {/* Ikona Twitter/X */}
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
